...
<spring:eval expression="@environment.getProperty('system.version')" var="systemVersion" />
...
<div class="footer">
     <div class="container">
       <p class="text-muted">
       	...
       	&nbsp;|&nbsp; <strong>versão:</strong> ${systemVersion} 
       </p>
     </div> 
</div>	   
<script src="${pageContext.request.contextPath}/resources/core/shortcut.js"></script>
<script>
